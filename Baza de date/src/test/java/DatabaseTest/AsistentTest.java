...
class AsistentTest {
    ...
    void asistentInsert() throws Exception {
        ...
        p.insertIntoDB("1990505000000", "grad", "test");
        expected.add("grad");
        expected.add("test");
    ...
    void asistentUpdate() throws Exception {
        ...
        p.updateInDB("1990505000000", "grad", "junior");
        expected.add("junior");
        expected.add("test");
    ...
    void asistentGetDocByField() throws Exception {
        ...
        for (Map<String, Object> map : p.getDocumentByField("grad", "junior")) {
    ...
    void asistentGetCollection() throws Exception {
        ...
        expected.add("gradTEST");
        expected.add("spitalTEST");
